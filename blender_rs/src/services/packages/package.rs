...
use crate::services::{category::BlenderCategoryError, packages::{bundle::Bundle, custom::Custom, download_link::DownloadLink, downloaded::Downloaded}};
...
impl Package {
    ...
    pub fn check_package(link: DownloadLink, destination: impl AsRef<Path>) -> Result<Package, BlenderCategoryError> {
    ...
    pub fn get_package_ready(self, destination: impl AsRef<Path>) -> Result<Package, BlenderCategoryError> {
        match self {
